...
int main() {
    ...
    std::cout << dediHetznerStorage << "Server costs " << dediHetznerStorage.calculatePriceYears(5) << " EUR for 5 years.\n";
    std::cout << dediHetznerStorage.splitAuto() << "Server costs " << dediHetznerStorage.splitAuto().calculatePriceYears(5) << " EUR for 5 years.\n";
